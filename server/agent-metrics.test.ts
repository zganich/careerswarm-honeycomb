  ...
  () => {
    ...
    beforeAll(async () => {
      ...
      if (db) {
        await db
          .delete(agentMetrics)
          .where(eq(agentMetrics.userId, testUserId));
      }
    });
    ...
    it("should track Tailor agent metrics on success", async () => {
      const input = {
        ...
        jobDescription:
          "Senior Software Engineer position requiring Python, TypeScript, and cloud infrastructure experience.",
    ...
    it("should track Scribe agent metrics on success", async () => {
      const input = {
        ...
        roleTitle: "Senior Software Engineer",
        strategicMemo:
          "Test Company recently raised $50M Series B and is expanding their engineering team.",
        jobDescription:
          "Senior Software Engineer position requiring Python, TypeScript, and cloud infrastructure experience.",
      };
