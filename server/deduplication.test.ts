...
describe("Deduplication Logic", () => {
  describe("String Similarity Comparison", () => {
    ...
    it("should detect near-duplicates above 85% threshold", () => {
      const str1 =
        "Implemented automated testing framework for React applications";
  ...
  describe("Deduplication Algorithm", () => {
    ...
    it("should keep all unique achievements", () => {
      const existing = [{ action: "Implemented automated testing framework" }];
  ...
  describe("Response Format", () => {
    it("should return added and skipped counts", () => {
      const mockResponse = {
        ...
        count: 3,
        message:
          "Successfully imported 3 achievement(s) (2 duplicates removed)",
      };
    ...
    it("should format message with single duplicate", () => {
      ...
      expect(message).toBe(
        "Successfully imported 4 achievement(s) (1 duplicate removed)"
      );
    });
    ...
    it("should format message with multiple duplicates", () => {
      ...
      expect(message).toBe(
        "Successfully imported 3 achievement(s) (5 duplicates removed)"
      );
    });
  });
});
