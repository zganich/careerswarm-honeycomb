...
test("TypeScript compilation clean", () => {
  try {
    execSync(
      'cd /home/ubuntu/careerswarm && pnpm check 2>&1 | grep "Found 0 errors"',
      {
        encoding: "utf-8",
        stdio: "pipe",
      }
...
test("Notification scheduler initialized", () => {
  try {
    const logs = execSync(
      'cd /home/ubuntu/careerswarm && tail -100 .manus-logs/devserver.log | grep -i "notification\\|scheduler" || echo "no logs"',
      {
        encoding: "utf-8",
        stdio: "pipe",
      }
...
test("Resume templates configured", () => {
  try {
    ...
    execSync(
      "test -f /home/ubuntu/careerswarm/client/src/components/ResumeRenderer.tsx"
    );
  } catch {
...
test("Welcome wizard component exists", () => {
  try {
    execSync(
      "test -f /home/ubuntu/careerswarm/client/src/components/WelcomeWizard.tsx"
    );
  } catch {
