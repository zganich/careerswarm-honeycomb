...
export const userProfiles = mysqlTable("userProfiles", {
  ...
  parsedContactFromResume: json("parsedContactFromResume").$type<
    Record<string, any>
  >(),
...
export const achievements = mysqlTable("achievements", {
  ...
  responseRateWithAchievement: decimal("responseRateWithAchievement", {
    precision: 5,
    scale: 2,
  }), // Calculated
...
export const certifications = mysqlTable("certifications", {
  ...
  type: mysqlEnum("type", ["certification", "license"]).default(
    "certification"
  ),
...
export type InsertVolunteerExperience =
  typeof volunteerExperiences.$inferInsert;
