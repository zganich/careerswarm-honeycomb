      ...
      >
        ...
        {data.skills.technical && data.skills.technical.length > 0 && (
          <div style={{ marginBottom: "4px" }}>
            <strong style={{ fontSize: styles.fontSize.body }}>
              Technical:{" "}
            </strong>
            <span style={{ fontSize: styles.fontSize.body }}>
          ...
          <div key={idx} style={{ marginBottom: styles.spacing.item }}>
            ...
            >
              ...
              {project.link && (
                <a
                  href={project.link}
                  style={{ color: styles.accentColor, marginLeft: "8px" }}
                >
                  Link
                </a>
              )}
    ...
    return (
      ...
      >
        ...
        {data.certifications.map((cert, idx) => (
          <div
            key={idx}
            style={{ marginBottom: "4px", fontSize: styles.fontSize.body }}
          >
