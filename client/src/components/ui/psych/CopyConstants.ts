...
export const PSYCH_COPY = {
  ...
  onboarding: {
    welcome: {
      ...
      subtitle:
        "In 5 minutes, you'll have a Master Profile that powers unlimited applications.",
      cta: "Start Building",
    },
    extraction: {
      title: "AI is Analyzing Your Career",
      subtitle:
        "Watch as we transform your resume into a structured evidence graph.",
    },
    review: {
      title: "Review Your Master Profile",
      subtitle:
        "Edit anything before we start matching you with opportunities.",
    },
  },
