...
export function LaborIllusion({ variant, onComplete, className = "" }: LaborIllusionProps) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-slate-900">
              {variant === "extraction" ? "AI is analyzing your career data" : "AI is building your application"}
            </h3>
            ...
            return (
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                  ...
                  isCurrent ? "bg-orange-100 text-orange-600 animate-pulse" :
