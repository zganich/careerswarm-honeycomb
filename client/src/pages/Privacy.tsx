        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Careerswarm ("we", "our", or "us") is committed to protecting your
              privacy. This Privacy Policy explains how we collect, use,
              disclose, and safeguard your information when you use our
              AI-powered career evidence platform. By using Careerswarm, you
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
              ...
              <li>
                Profile information (current role, company, years of experience,
                target roles)
              </li>
            </ul>

            <h3 className="text-xl font-semibold mb-3 text-foreground">
              2.2 Career Evidence Data
            </h3>
            <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              credit card information. We only store your Stripe customer ID,
              subscription ID, and subscription status.
            </p>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              ...
              <li>
                Process your achievements using AI (STAR → XYZ transformation)
              </li>
              ...
              <li>
                Send service-related notifications (application reminders,
                interview prep)
              </li>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              career evidence data to third parties for marketing purposes.
            </p>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-4">
              <li>
                <strong>Infrastructure:</strong> Hosting, authentication, and
                database
              </li>
              <li>
              ...
              <li>
                <strong>OpenAI/Anthropic:</strong> AI model providers for
                achievement transformation and job matching (data is not used
                for model training)
              </li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              ...
              <li>
                Secure password hashing (OAuth providers handle authentication)
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              To exercise these rights, contact us at privacy@careerswarm.com.
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              delete your personal data and career evidence within 90 days,
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>
                <strong>Authentication:</strong> HTTP-only session cookies to
                keep you logged in
              </li>
              <li>
                <strong>Analytics:</strong> Umami (privacy-friendly,
                GDPR-compliant) to track page views and feature usage
              </li>
            </ul>
            <p className="text-muted-foreground leading-relaxed mt-4">
              We do not use third-party advertising cookies or trackers. You can
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Careerswarm is not intended for users under 16 years of age. We do
              not knowingly collect personal information from children. If you
              believe we have collected data from a child, contact us
              immediately at privacy@careerswarm.com.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              your jurisdiction. We ensure adequate safeguards are in place
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              notify you of significant changes by email or prominent notice on
              our platform. Continued use of Careerswarm after changes
          ...
          <section>
            ...
            <ul className="list-none text-muted-foreground space-y-2">
              <li>
                <strong>Email:</strong> privacy@careerswarm.com
              </li>
              <li>
