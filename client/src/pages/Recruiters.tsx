  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight">
            Find Candidates Who{" "}
            <span className="text-orange-500">Actually Stand Out</span>
          </h1>

          <p className="text-xl text-slate-600 mb-8 leading-relaxed">
            CareerSwarm helps job seekers create{" "}
            <strong>quantified, ATS-optimized applications</strong> that make
            your screening process faster and more effective.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button
              onClick={() =>
                (window.location.href = "mailto:partnerships@careerswarm.com")
              }
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200">
              ...
              <p className="text-slate-700">
                Every CareerSwarm resume includes specific metrics and outcomes.
                No more vague "responsible for" statements—just measurable
                impact.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200">
              ...
              <p className="text-slate-700">
                Applications are structured for easy parsing by your ATS. Clean
                formatting, proper keywords, and scannable sections save your
                team hours.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-green-50 to-green-100 border border-green-200">
              ...
              <p className="text-slate-700">
                Consistent formatting and clear achievement statements let you
                evaluate candidates 3x faster. Spend less time decoding resumes.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
              ...
              <p className="text-slate-700">
                Candidates using CareerSwarm are serious about their
                applications. They've invested time building comprehensive
                profiles.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-amber-50 to-amber-100 border border-amber-200">
              ...
              <p className="text-slate-700">
                Candidates arrive prepared with tailored materials. This means
                better interviews and stronger hires who understand your
                company.
              </p>
            </div>
            ...
            <div className="p-8 rounded-2xl bg-gradient-to-br from-rose-50 to-rose-100 border border-rose-200">
              ...
              <p className="text-slate-700">
                CareerSwarm users proactively reach out to hiring managers with
                personalized messages—reducing your sourcing burden.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-orange-500 to-orange-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 text-orange-100">
            Partner with CareerSwarm to receive higher-quality applications and
            ...
            <button
              onClick={() =>
                (window.location.href =
                  "mailto:partnerships@careerswarm.com?subject=Recruiter Partnership Inquiry")
              }
      ...
      <footer className="py-8 px-6 bg-slate-900 text-slate-400 text-center">
        <p className="text-sm">© 2026 CareerSwarm. All rights reserved.</p>
      </footer>
    </div>
  );
}
